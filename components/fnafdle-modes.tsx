        ...
        {MODES.map((m) => {
          ...
          return (
            <button
              ...
              className={`group flex items-center gap-1.5 rounded-sm border px-2.5 py-1.5 font-mono text-[10px] uppercase tracking-wider transition-all ${
                active
            ...
            >
              <span
                className={`h-1.5 w-1.5 rounded-[1px] transition-colors ${
                  active ? "bg-signal shadow-[0_0_6px_rgba(126,224,129,0.9)]" : "bg-seam group-hover:bg-bone-dim"
                }`}
              />
